...
// TODO: Enable tests when CubicChainCircuit and SmallSha256Circuit are ported
#[cfg(any())] // disabled: missing test infrastructure (CubicChainCircuit, SmallSha256Circuit)
mod tests {
  use super::*;
  use crate::{
    big_num::{DelayedReduction, SmallValueField, WideMul},
